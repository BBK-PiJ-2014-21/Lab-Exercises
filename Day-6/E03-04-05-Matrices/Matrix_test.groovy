...
// testing constructor, prettyPrint(), toString(), setRow()
	...
	System.out.println();
	m1.setRow(0, "0,9");
	System.out.println("testing setRow(1, \"0,9\")");
	m1.prettyPrint();
	System.out.println();
	m1.setRow(1, "8,5");
	...
	System.out.println();
	m1.setRow(0, "2,8,5");
	System.out.println("testing setRow(0, \"2,8,5\") // two parameters needed");
	m1.prettyPrint();
	System.out.println();
	m1.setRow(0, "6,6,");
	System.out.println("testing error setRow(0, \"6,6,\") // invalid input");
	m1.prettyPrint();
	System.out.println();
	m1.setRow(0, "6,,,");
	System.out.println("testing error setRow(0, \"6,,,\") // invalid input");
	m1.prettyPrint();
		
// testing isSymmetrical - 2D array
	int[][] twoDsymmetrical1 = {{0,1,2},{1,0,2},{2,2,0}};
	int[][] twoDsymmetrical2 = {{1,2},{2,1}};
	int[][] twoDaSymmetrical = {{111,222},{2,1}};
	System.out.println(twoDsymmetrical1.isSymmetrical());	// should print 'true';
	System.out.println(twoDsymmetrical2.isSymmetrical());	// should print 'true';
	System.out.println(m.isSymmetrical(twoDSymmetrical));	// should print 'false';
	System.out.println();
		
// testing isTriangular
